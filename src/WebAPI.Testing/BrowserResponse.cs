...
namespace Nancy.Testing
{
    ...
    public class BrowserResponse
    {
        ...
        /// </summary>
        /// <param name="context">The <see cref="HttpControllerContext"/> that <see cref="Browser"/> was invoked with.</param>
        ...
        public BrowserResponse(HttpControllerContext context, Browser hostBrowser)
        {
            if (context == null)
            {
        ...
        public BrowserResponseBodyWrapper Body
        {
            get
            {
                return this.body ?? (this.body = new BrowserResponseBodyWrapper(this.));
            }
        }
        ...
        /// </summary>
        /// <value>A <see cref="HttpControllerContext"/> instance.</value>
        public HttpControllerContext Context { get; private set; }
