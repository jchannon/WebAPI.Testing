...
namespace Nancy.Testing
{
    ...
    /// <summary>
    /// Defines extensions for the <see cref="HttpControllerContext"/> type.
    /// </summary>
    public static class HttpControllerContextExtensions
    {
		...
		private static T Cache<T>(HttpControllerContext context, string key, Func<T> getData)
		{
		...
		/// <summary>
		/// Returns the HTTP response body, of the specified <see cref="HttpControllerContext"/>, wrapped in an <see cref="DocumentWrapper"/> instance.
		/// </summary>
		/// <param name="context">The <see cref="HttpControllerContext"/> instance that the HTTP response body should be retrieved from.</param>
		/// <returns>A <see cref="DocumentWrapper"/> instance, wrapping the HTTP response body of the context.</returns>
		public static DocumentWrapper DocumentBody(this HttpControllerContext context)
		{
		...
		public static TModel JsonBody<TModel>(this HttpControllerContext context)
		{
		...
		public static TModel XmlBody<TModel>(this HttpControllerContext context)
		{
