namespace Nancy.Testing
{
    ...
    public class ConfigurableNancyModule : NancyModule
    {
        ...
        public class ConfigurableNancyModuleConfigurator : IHideObjectMembers
        {
            ...
            /// <param name="action">The action that should be invoked by the route.</param>
            /// <returns>An instance to the current <see cref="ConfigurableNancyModuleConfigurator"/>.</returns>
            public ConfigurableNancyModuleConfigurator Delete(string path, Func<HttpControllerContext, bool> condition, Func<dynamic, NancyModule, dynamic> action)
            {
            ...
            /// <param name="action">The action that should be invoked by the route.</param>
            /// <returns>An instance to the current <see cref="ConfigurableNancyModuleConfigurator"/>.</returns>
            public ConfigurableNancyModuleConfigurator Get(string path, Func<HttpControllerContext, bool> condition, Func<dynamic, NancyModule, dynamic> action)
            {
            ...
            /// <param name="action">The action that should be invoked by the route.</param>
            /// <returns>An instance to the current <see cref="ConfigurableNancyModuleConfigurator"/>.</returns>
            public ConfigurableNancyModuleConfigurator Patch(string path, Func<HttpControllerContext, bool> condition, Func<dynamic, NancyModule, dynamic> action)
            {
            ...
            /// <param name="action">The action that should be invoked by the route.</param>
            /// <returns>An instance to the current <see cref="ConfigurableNancyModuleConfigurator"/>.</returns>
            public ConfigurableNancyModuleConfigurator Post(string path, Func<HttpControllerContext, bool> condition, Func<dynamic, NancyModule, dynamic> action)
            {
            ...
            /// <param name="action">The action that should be invoked by the route.</param>
            /// <returns>An instance to the current <see cref="ConfigurableNancyModuleConfigurator"/>.</returns>
            public ConfigurableNancyModuleConfigurator Put(string path, Func<HttpControllerContext, bool> condition, Func<dynamic, NancyModule, dynamic> action)
            {
                this.module.Post[path, GetSafeRouteCondition(condition)] = GetSafeRouteAction(action);
                return this;
            }
            ...
            /// <param name="action">The action that should be invoked by the route.</param>
            /// <returns>An instance to the current <see cref="ConfigurableNancyModuleConfigurator"/>.</returns>
            public ConfigurableNancyModuleConfigurator Options(string path, Func<HttpControllerContext, bool> condition, Func<dynamic, NancyModule, dynamic> action)
            {
            ...
            private static Func<HttpControllerContext, bool> GetSafeRouteCondition(Func<HttpControllerContext, bool> condition)
            {
