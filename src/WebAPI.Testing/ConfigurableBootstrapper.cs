namespace Nancy.Testing
{
    ...
    public class ConfigurableBootstrapper : NancyBootstrapperWithRequestContainerBase<TinyIoCContainer>, IPipelines, INancyModuleCatalog
    {
        ...
        private readonly List<Action<TinyIoCContainer, IPipelines, HttpControllerContext>> requestStartupActions;
        ...
        public ConfigurableBootstrapper(Action<ConfigurableBoostrapperConfigurator> configuration)
        {
            ...
            this.requestStartupActions = new List<Action<TinyIoCContainer, IPipelines, HttpControllerContext>>();
        ...
        protected override void RequestStartup(TinyIoCContainer container, IPipelines pipelines, HttpControllerContext context)
        {
        ...
        public new IEnumerable<NancyModule> GetAllModules(HttpControllerContext context)
        {
        ...
        public new NancyModule GetModuleByKey(string moduleKey, HttpControllerContext context)
        {
            var module = 
        ...
        public class ConfigurableBoostrapperConfigurator
        {
            ...
            /// <summary>
            /// Configures the bootstrapper to use the provided instance of <see cref="IHttpControllerContextFactory"/>.
            /// </summary>
            /// <param name="contextFactory">The <see cref="IHttpControllerContextFactory"/> instance that should be used by the bootstrapper.</param>
            /// <returns>A reference to the current <see cref="ConfigurableBoostrapperConfigurator"/>.</returns>
            public ConfigurableBoostrapperConfigurator ContextFactory(IHttpControllerContextFactory contextFactory)
            {
                this.bootstrapper.registeredInstances.Add(
                    new InstanceRegistration(typeof(IHttpControllerContextFactory), contextFactory));

                return this;
            }

            /// <summary>
            /// Configures the bootstrapper to create an <see cref="IHttpControllerContextFactory"/> instance of the specified type.
            /// </summary>
            /// <typeparam name="T">The type of the <see cref="IHttpControllerContextFactory"/> that the bootstrapper should use.</typeparam>
            /// <returns>A reference to the current <see cref="ConfigurableBoostrapperConfigurator"/>.</returns>
            public ConfigurableBoostrapperConfigurator ContextFactory<T>() where T : IHttpControllerContextFactory
            {
            ...
            public ConfigurableBoostrapperConfigurator RequestStartup(Action<TinyIoCContainer, IPipelines, HttpControllerContext> action)
            {
        ...
        public class ConfigurableModuleCatalog : INancyModuleCatalog
        {
            ...
            /// <param name="context">The current context</param>
            /// <returns>An <see cref="IEnumerable{T}"/> instance containing <see cref="NancyModule"/> instances.</returns>
            public IEnumerable<NancyModule> GetAllModules(HttpControllerContext context)
            {
            ...
            /// <param name="context">The current context</param>
            /// <returns>The <see cref="NancyModule"/> instance that was retrived by the <paramref name="moduleKey"/> parameter.</returns>
            public NancyModule GetModuleByKey(string moduleKey, HttpControllerContext context)
            {
